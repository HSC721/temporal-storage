...
//        }
    ...
    public static class MergeTask implements BackgroundTask
    {
         ...
         * @param index
         */
        public MergeTask( File propStoreDir, MemTable memTable2merge, PropertyMetaData proMeta, TableCache cache, IndexStore index ) throws IOException {
...
//            clean up index.
        ...
        private List<Long> getFile2Merge(SortedMap<Long, FileMetaData> files) throws IOException {
            ...
            for( Long fileNo : new long[]{0,1,2,3,4} ) {
                ...
                if( null == metaData ) {
                    ...
                    String statTXT = "D:\\TGraph\\storage\\stat.Txt";
                    FileWriter fw = new FileWriter(statTXT, true);
                    PrintWriter pw = new PrintWriter(fw);
                    pw.println(metaData.getFileSize());
                    pw.flush();
